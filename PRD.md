...
| **🔐 Autentisering** | 🟡 Medel | Kundinloggning och skyddade rutter (*Mina sidor*, orderhistorik, favoriter).<br>*(Rekommenderat: **Clerk** eller **Kinde** för snabbast och säkrast integration med Next.js App Router).* |
